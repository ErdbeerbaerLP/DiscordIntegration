...
import de.erdbeerbaerlp.dcintegration.api.ArchitecturyDiscordEventHandler;
import de.erdbeerbaerlp.dcintegration.command.McCommandDiscord;
import de.erdbeerbaerlp.dcintegration.metrics.Metrics;
import de.erdbeerbaerlp.dcintegration.util.SerializeComponentUtils;
import de.erdbeerbaerlp.dcintegration.util.MessageUtilsImpl;
import de.erdbeerbaerlp.dcintegration.util.ServerInterface;
...
public final class DiscordIntegrationMod {
    ...
    public static void init() {
        DiscordIntegration.LOGGER.info("Starting Discord Integration");
        try {
